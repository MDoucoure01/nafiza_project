    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> Créer un nouveau cohorte </h2>
                    </div>
                    <div class="body">
                        <form class="form-horizontal">
                            <div class="row clearfix">
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                    <label for="email_address_2">Nom du cohorte</label>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="offset-lg-2 col-lg-10">
                                    <button type="button" class="btn btn-raised btn-warning m-t-15 waves-effect">Créer cohorte</button>
                                </div>
                            </div>
                        </form>
                    </div>
