        ...
        <div class="menu">
            <ul class="list">
                ...
                @php
                    ...
                    $isActiveProfessor = in_array(Route::currentRouteName(), $professorRoutes) ? 'active open' : '';
                @endphp
                <li class="{{ $isActiveProfessor }}"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account"></i><span>Professeurs</span> </a>
                    <ul class="ml-menu">
                        <li class="{{ Route::currentRouteName() == 'professor.add' ? 'active' : '' }}"><a href="{{ route('professor.add') }}">Ajouter professeur</a></li>
                        <li class="{{ Route::currentRouteName() == 'professors.list' ? 'active' : '' }}"><a href="{{ route('professors.list') }}">Liste des professeurs</a></li>
                ...
                @php
                    ...
                    $isActiveCourse = in_array(Route::currentRouteName(), $coursesRoutes) ? 'active open' : '';
                @endphp
                <li class="{{ $isActiveCourse }}"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-graduation-cap"></i><span>Cours</span> </a>
                    <ul class="ml-menu">
                        <li class="{{ Route::currentRouteName() == 'course.add' ? 'active' : '' }}"><a href="{{ route('course.add') }}">Ajouter cours</a></li>
                        <li class="{{ Route::currentRouteName() == 'courses.list' ? 'active' : '' }}"><a href="{{ route('courses.list') }}">Liste des cours</a></li>
                        <li class="{{ in_array(Route::currentRouteName(), ['courses.modules', 'module.show']) ? 'active' : '' }}"><a href="{{ route('courses.modules') }}">Gestion modules</a></li>
                    </ul>
                </li>

                @php
                    $seancesRoutes = ['seance.add', 'seances.list', 'attendance.sheet', 'seance.edit'];
                    $isActiveSeance = in_array(Route::currentRouteName(), $seancesRoutes) ? 'active open' : '';
                @endphp
                <li class="{{ $isActiveSeance }}"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Séances de cours</span> </a>
                    <ul class="ml-menu">
                        <li class="{{ Route::currentRouteName() == 'seance.add' ? 'active' : '' }}"><a href="{{ route('seance.add') }}">Ajouter séance</a></li>
                        <li class="{{ Route::currentRouteName() == 'seances.list' ? 'active' : '' }}"><a href="{{ route('seances.list') }}">Liste des séances</a></li>
                    </ul>
                </li>
                ...
                @php
                    $adminsRoutes = ['admin.add', 'admin.list', 'admin.edit'];
                    $isActiveUser = in_array(Route::currentRouteName(), $adminsRoutes) ? 'active' : '';
                @endphp
                <li class="{{ $isActiveUser }}"><a href="{{ route('admin.list') }}"><i class="zmdi zmdi-accounts"></i><span>Utilisateurs</span> </a></li>
            </ul>
        </div>
    </aside>
</section>
